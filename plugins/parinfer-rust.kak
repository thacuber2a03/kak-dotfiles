...
declare-option -docstring "Extra flags to pass to the parinfer-rust binary" str-list parinfer_extra_flags

# FIXME(thacuber2a03): this is completely stupid, but ok
